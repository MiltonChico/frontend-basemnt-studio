...
export function AnimatedLogo({ title }: { title: string }) {
  ...
  return (
    <div ref={containerRef} className="relative h-[46px] w-[123px] shrink-0">
      ...
      <div data-logo-right className="absolute inset-0 [clip-path:inset(0_0_0_50%)]">
        <Image src="/logo.svg" alt="" aria-hidden="true" width={123} height={46} priority />
      </div>
    </div>
  );
}
